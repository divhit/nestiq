...
function getDemoBranding(slug: string) {
  return {
    ...
    firstMessage: "Hi! I'm here to help you explore Vancouver real estate. What brings you here today?",
    headerLabel: "Ask me anything about Vancouver real estate",
    quickQuestions: [
